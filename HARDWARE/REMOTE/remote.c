 ...
 * @FunctionList
 *		1.void Remote_Init(void);     //红外传感器接收头引脚初始化
 *		2.u8 Remote_Scan(void);       //scan    
 */ 
#include "remote.h"
#include "delay.h"
#include "usart.h"
...
/**
 * @Function void Remote_Init(void);
 * @description 红外遥控初始化
 *							设置IO以及TIM2_CH1的输入捕获
 * @Input    void
 * @Return   void
...
u8  RmtCnt=0;	//按键按下的次数	 
/**
 * @Function void TIM1_UP_TIM10_IRQHandler(void)
...
/**
 * @Function void TIM1_CC_IRQHandler(void)
