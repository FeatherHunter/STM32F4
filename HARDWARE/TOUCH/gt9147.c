 ...
 * @filename gt9147.c
 * @description 4.3寸电容触摸屏-GT9147 驱动代码	 
 * @FunctionList
...
/**
 * @Function u8 GT9147_Init(void);
 * @description 初始化GT9147触摸屏
 *								PB1,PC11
 * @Input void
...
/**
 * @Function u8 GT9147_Send_Cfg(u8 mode)
 * @description 发送GT9147配置参数
 * @Input u8 mode:0,参数不保存到flash
 *                1,参数保存到flash
 * @Return  u8: 0 SUCCESS
 */	
...
/**
 * @Function u8 GT9147_WR_Reg(u16 reg,u8 *buf,u8 len)
 * @description 向GT9147写入一次数据
 * @Input u16 reg:起始寄存器地址
 *				u8* buf:数据缓缓存区
 *				u8  len:写数据长度
 * @Return  0,成功;1,失败.
 */	
...
/**
 * @Function void GT9147_RD_Reg(u16 reg,u8 *buf,u8 len);
 * @description 从GT9147读出一次数据
 * @Input u16 reg:起始寄存器地址
 *				u8* buf:数据缓缓存区
 *				u8  len:读数据长度
 * @Return void
...
/**
 * @Function u8 GT9147_Scan(u8 mode);
