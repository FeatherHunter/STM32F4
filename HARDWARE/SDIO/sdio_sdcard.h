...
////////////////////////////////////////////////////////////////////////////////////////////////////
//相关函数定义
SD_Error SD_Init(void);                      		 //初始化
void SDIO_Clock_Set(u8 clkdiv);              		 //SDIO时钟初始化设置

SD_Error SD_PowerON(void);                   		 //卡上电
SD_Error SD_PowerOFF(void);                  		 //POWER OFF
SD_Error SD_InitializeCards(void);           		 //初始化所有卡并进入就绪状态
SD_Error SD_GetCardInfo(SD_CardInfo *cardinfo);	 //得到卡信息	  
...
void SD_DMA_Config(u32*mbuf,u32 bufsize,u32 dir);  //配置SDIO DMA  
