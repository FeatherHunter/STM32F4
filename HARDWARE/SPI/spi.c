 ...
 * @description spi
 * @FunctionList
 *		1.void SPI1_Init(void);			 				 //初始化SPI1口
 *		2.void SPI1_SetSpeed(u8 SpeedSet);   //设置SPI1速度   
 *		3.u8 SPI1_ReadWriteByte(u8 TxData);  //SPI1总线读写一个字节
 */ 
 ...
 * @description 以下是SPI模块的初始化代码，配置成主机模式 						  
 *							SPI口初始化
 *              这里针是对SPI1的初始化
 * @Input 	void
 * @Return  void
